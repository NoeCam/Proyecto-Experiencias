...
const updateRecoverPassModel = async (email, recoverPassCode) => {
    ...
    const emailSubject = 'Recuperación de contraseña en Experiencias Diferentes :)';

    // Creamos el contenido del email
    const emailBody = `
            Se ha solicitado la recuperación de contraseña para este email en Experiencias Diferentes. 
