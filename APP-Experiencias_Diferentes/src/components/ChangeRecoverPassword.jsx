    ...
    <>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div>
                ...
                <input type="text" name="recoverPassCode"  onChange={(e) => setRecoverPassCode(e.target.value)}/>
            </div>
            <div>
            ...
            <div>
                ...
                <input type="password" name="newPasswordRepeat"  onChange={(e) => setNewPasswordRepeat(e.target.value)}/>
            </div>
